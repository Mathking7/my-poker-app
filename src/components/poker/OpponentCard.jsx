import { Coins, Crown, Timer } from 'lucide-react';
...
export default function OpponentCard({
  ...
  return (
    ...
    >
      ...
      <div className="poker-player-name font-bold truncate w-full text-center relative pt-1 text-slate-200">{player.name} {player.waitingNextHand ? '(下局加入)' : (player.isSittingOut && '(观战)')}</div>
